        ...
        <div className="mt-10 -mx-6 overflow-x-auto px-6">
          <div className="flex min-w-max items-stretch gap-3">
            {workflowSteps.map((step, index) => (
              ...
              >
                <div className="flex w-40 flex-col justify-between rounded-xl border border-steel/25 bg-paper-elev p-4 transition-colors duration-[var(--duration-standard)] hover:border-steel/40">
                ...
                {index < workflowSteps.length - 1 && (
                  <span className="flex items-center text-steel" aria-hidden>
                    →
                  </span>
                )}
              </Reveal>
