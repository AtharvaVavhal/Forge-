      ...
      <div className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed text-ink/80">
          ...
          <p>
            ...
            personal training, diet plans, supplements — sit on top of the
            core membership record rather than as separate, disconnected
            systems.
          </p>
          <p>
            Every action that changes a member&apos;s status — check-in,
            follow-up, renewal, add-on — is captured through audit logging,
            and the retention KPIs on the owner dashboard are calculated
            from that same underlying data rather than a separate reporting
            layer.
          </p>
        </div>
      </div>
