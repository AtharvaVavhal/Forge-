    ...
    <section className="bg-paper">
      <div className="mx-auto max-w-4xl px-6 py-20">
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-ink/80">
          Instead of treating attendance, follow-up and renewals as separate
          tools, the platform connects them into a single workflow — so
          what a member does at check-in shows up directly in what the
          owner sees on the dashboard.
        </p>
      </div>
    </section>
  );
