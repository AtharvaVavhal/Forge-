    ...
    <div className="bg-paper">
      ...
      <section className="mx-auto max-w-3xl px-6 py-14">
        ...
        <p className="mt-4 text-base leading-relaxed text-ink/80">
          ...
          around what your business actually needs. After a short discovery
          call, we send a fixed proposal with a milestone-based schedule, so
          you know the cost and the delivery plan before development
          starts.
        </p>
      ...
      <section className="mx-auto max-w-3xl px-6 py-14 pb-24">
        ...
        <Link
          href="/contact"
          className="font-display mt-8 inline-flex rounded-full bg-ember px-6 py-3 text-sm font-semibold text-paper transition-opacity hover:opacity-90"
        >
          Start a Project
        </Link>
      </section>
